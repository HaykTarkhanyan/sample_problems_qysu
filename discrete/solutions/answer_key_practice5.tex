...
Count of integers from 0 to 1000 whose digits contain \emph{exactly one} 6.

Write each integer $0$--$999$ as a 3-digit string with leading zeros (leading zeros add no 6's). Exactly one of the three digits is a 6: choose its position ($3$ ways), set it to 6, and fill the other two with non-6 digits ($9$ each). The number $1000$ has no 6.
\[ \binom{3}{1}\cdot 9^2 = 3\cdot 81 = \boxed{243} \]

\subsubsection*{Problem 2}
Count of integers from 0 to 1000 whose digits contain \emph{one or more} 6 (at least one).
...
\end{itemize}
No-six total: $9+72+648+1=730$; all integers from 0 to 1000: $1001$.
...
(b) Of those (divisible by 5), how many are also divisible by 3? They are exactly the multiples of $\operatorname{lcm}(3,5)=15$: $\lfloor 699/15\rfloor = \boxed{46}$.

(c) Of those, how many are divisible by both 3 and 5 (i.e.\ by 15): $\lfloor 699/15\rfloor = \boxed{46}$.
