...
Prove $a^3 > 3a^2 + 3a + 1$ for $a \ge 4$; equivalently $(a+1)^3 < (2a)^3$... Actually, restate: prove $a^3 > 3a^2 + 3a + 1$ for $a \ge 4$.
...
Prove $5^{2n} + 3 \cdot 2^{5n-2}$ is divisible by 7 for $n \in \mathbb{N}$.
...
Prove $3^{n+2} + 4^{2n+1}$ is divisible by 13 for $n \in \mathbb{N}$.
...
Prove $5^{2n} + 7$ is divisible by 8 for $n \in \mathbb{N}$.
...
Using Theorems 1 \& 2, prove identities. (Note: the problem text is partially illegible; representative sub-problems are addressed.)
