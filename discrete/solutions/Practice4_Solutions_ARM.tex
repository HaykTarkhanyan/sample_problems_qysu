...
\begin{itemize}[nosep]
  \item \textbf{Որոշման տիրույթը}՝ $D(f)$-ը, բոլոր այն $x \in \R$ թվերի բազմությունն է,
        որոնց համար բանաձևը իմաստ ունի (բաժանում զրոյի վրա չկա, բացասական թվից քառակուսի արմատ չկա, և այլն)։
  \item \textbf{Արժեքների տիրույթը}՝ $E(f) = \{f(x) \mid x \in D(f)\}$-ը, 
...
\midrule
$\sqrt{g(x)}$ & $g(x) \ge 0$ & իրական թվերի բազմությունում բացասական թվի արմատն որոշված չէ \\
$1/g(x)$ & $g(x) \neq 0$ & բաժանում զրոյի վրա անթույլատրելի է \\
$1/\sqrt{g(x)}$ & $g(x) > 0$ & երկու պայմանների միաժամանակյա կիրառում \\
\bottomrule
\end{tabular}
\end{center}
\end{theorybox}
...
\begin{answerbox}
$D(f) = \R, \quad E(f) = [3, +\infty).$
\end{answerbox}

\bigskip
\textbf{(b)\; $f(x) = \sqrt{x+2}$.}

Անհրաժեշտ է, որ բավարարվի $x + 2 \ge 0$ պայմանը, այսինքն՝ $x \ge -2$։
\[
  D(f) = [-2, +\infty).
\]
...
\[
  E(f) = \left(0,\; \tfrac{1}{2}\right].
\]

\begin{answerbox}
$D(f) = \R, \quad E(f) = \bigl(0,\, \frac{1}{2}\bigr].$
\end{answerbox}
...
\[
  E(f) = \left(-\infty,\; -\tfrac{1}{2}\right] \cup (0, +\infty).
\]

\begin{answerbox}
$D(f) = \R \setminus \{-\sqrt{2},\, \sqrt{2}\}, \quad
 E(f) = \bigl(-\infty,\, -\tfrac{1}{2}\bigr] \cup (0, +\infty).$
\end{answerbox}
...
\]
\textbf{Կարդացվում է աջից ձախ՝} նախ կիրառեք $g$-ն, հետո ստացված արդյունքի վրա կիրառեք $f$-ը։
...
\textbf{Որոշման տիրույթի ստուգում.}\; Բանաձևը հաշվելուց հետո ստուգեք, թե որտեղ է այն որոշված։ $(g \circ f)(x)$-ի համար պահանջվում է $x \in D(f)$ և $f(x) \in D(g)$։
...
\begin{itemize}[nosep]
  \item \textbf{Ինյեկտիվ} (միարժեք). $f(x_1) = f(x_2) \implies x_1 = x_2$։
        ...
        \emph{Հորիզոնական ուղղի հայտանիշ.} յուրաքանչյուր հորիզոնական գիծ հատում է գրաֆիկը առավելագույնը մեկ անգամ։
...
\end{tikzpicture}
\end{center}
$\operatorname{Ker}(f)$-ի համարժեքության դասերը ճշգրտորեն համընկնում են $b \in E(f)$-ի
\textbf{նախապատկերների} (fibers/preimages) հետ՝ $f^{-1}(\{b\}) = \{a \in A \mid f(a) = b\}$։
\end{theorybox}
...
\]
Կիրառելով համեմատության հիմնական հատկությունը (քանի որ հայտարարները դրական են...)։
\[
...
Մենք պնդում ենք, որ $y = \frac{1}{2}$ թիվը պատկանում է $\Q^+$-ին, բայց չի պատկանում $E(f)$-ին։
...
Այսպիսով $E(f) \subseteq \bigl(0, \frac{1}{2}\bigr)$, ուստի $f$-ը սյուրյեկտիվ չէ $\Q^+$-ի վրա։ \qed

\begin{answerbox}
$f(x) = \frac{x}{2x+1}$-ը $\Q^+$-ի վրա \textbf{ինյեկտիվ} է (խաչաձև բազմապատկումից),
բայց \textbf{սյուրյեկտիվ չէ} (օրինակ, $y = \frac{1}{2}$-ը $E(f)$-ում չէ, քանի որ $f(x) < \frac{1}{2}$ բոլոր $x > 0$-ների համար)։
\end{answerbox}
...
\textbf{Անհրաժեշտություն. Եթե $f$-ը ինյեկտիվ է, ապա $f(A \cap B) = f(A) \cap f(B)$։}
...
\bigskip
\textbf{Բավարարություն. Եթե $f(A \cap B) = f(A) \cap f(B)$ բոլոր $A, B$-երի համար, ապա $f$-ը ինյեկտիվ է։}
...
% ══════════════════════════════════════════════════════════════════
\newpage
\section{Խնդիր 22 — Հավասար պատկերներ ունեցող չհատվող ենթաբազմություններ}
% ══════════════════════════════════════════════════════════════════
...
արժեքին (պատկերին)։ Սա նշանակում է, որ որոշման տիրույթի չհատվող ենթաբազմություններ կարող են
ունենալ հատվող, կամ նույնիսկ հավասար, պատկերներ։
\end{theorybox}

\begin{problembox}
Հնարավո՞ր է արդյոք, որ $f : A \to B$-ն և չհատվող ու ոչ դատարկ $X_1, X_2 \subseteq A$ ենթաբազմությունները
...
% ══════════════════════════════════════════════════════════════════
\newpage
\section{Խնդիր 24 — Չհատվող բազմությունների նախապատկերներ}
% ══════════════════════════════════════════════════════════════════
...
Որպես այլընտրանք՝ կարող ենք կիրառել հակասող ենթադրության մեթոդը։ Ենթադրենք հակառակը՝ գոյություն ունի
...
\bigskip
\textbf{Հարակից փաստ.}\; Հակառակ ներդրումը՝ $X \subseteq f^{-1}\bigl(f(X)\bigr)$, միշտ տեղի ունի, իսկ հավասարությունը՝ այն և միայն այն դեպքում, երբ $f$-ը ինյեկտիվ է։ Այս խնդրի $f\bigl(f^{-1}(Y)\bigr) \subseteq Y$ արդյունքի հետ միասին, այս երկու ներդրումները ցույց են տալիս, թե ինչպես են պատկերներն ու նախապատկերները փոխազդում։

% ══════════════════════════════════════════════════════════════════
\newpage
\section{Կարդինալ թվեր և անվերջ բազմություններ (Cardinality)}
% ══════════════════════════════════════════════════════════════════

\begin{tcolorbox}[colback=white, colframe=gray!50, arc=2mm, width=0.9\textwidth, halign=center]
  \textbf{Տեսանյութ.} Բնական թվե՞րն են ավելի շատ, թե՞ $[0, 1]$-ի թվերը \\
  (Հաշվելի և անհաշվելի բազմություններ) \\
  \href{https://youtu.be/nU3fzO94lBw}{\textbf{[VIDEO]} Դիտել YouTube-ում (ID: nU3fzO94lBw)}
\end{tcolorbox}
