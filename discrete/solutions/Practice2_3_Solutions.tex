...
Since every pair appears with its reverse, the relation is symmetric. Undirected edges: $a\text{--}b$,\; $b\text{--}c$,\; $a\text{--}c$,\; $d\text{--}e$.
...
Undirected edges: $a\text{--}b$,\; $b\text{--}c$,\; $c\text{--}d$,\; $a\text{--}c$.
...
\textbf{Key observation:} $\alpha \circ \beta \ne \beta \circ \alpha$, confirming that composition of relations is \emph{not commutative} in general.
...
\begin{align*}
  r(\alpha) &= \alpha \cup \{(1,1),\,(2,2),\,(3,3),\,(4,4)\} \\
            &= \{(1,1),\,(1,2),\,(2,2),\,(2,4),\,(3,1),\,(3,2),\,(3,3),\,(4,4)\}.
\end{align*}
