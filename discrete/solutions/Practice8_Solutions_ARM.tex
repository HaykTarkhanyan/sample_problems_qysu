...
% ── Packages ──────────────────────────────────────────────────────
\usepackage{fontspec}
\setmainfont{Sylfaen} % Or any other font that supports Armenian (e.g., GHEA Mariam, Arial)
...
\newtcolorbox{problembox}{%
  ...
  fonttitle=\bfseries, title={\small Խնդրի Պայմանը},
  breakable, enhanced, arc=2mm,
  left=5pt, right=5pt, top=5pt, bottom=5pt
}
...
\author{Դիսկրետ Մաթեմատիկա — QYSU}
\date{}
