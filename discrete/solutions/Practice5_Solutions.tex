...
Total handshakes among all $15+12+10=37$ people: $\binom{37}{2}$.
Subtract handshakes within each group (same subject): $\binom{15}{2} + \binom{12}{2} + \binom{10}{2}$.
...
\textbf{Example.}\; $2\,143\,658$ is a valid 7-digit number (leading digit $\neq 0$). But $0\,143\,658$ is not, because it would be a 6-digit number. The leading-digit restriction removes exactly $\frac{1}{10}$ of all 7-character strings.
