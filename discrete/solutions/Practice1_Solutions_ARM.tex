...
% ══════════════════════════════════════════════════════════════════
\newpage
\section{Լրացուցիչ խնդիրներ՝ տեսանյութերով}
% ══════════════════════════════════════════════════════════════════

Ստորև ներկայացված են այլ խնդիրների լուծումներ, որոնք հասանելի են որպես տեսանյութեր։

\begin{itemize}[itemsep=10pt]

\item \textbf{Բազմությունների տեսություն.}
    \begin{itemize}
    \item $A \cap (B \setminus C) = (A \cap B) \setminus C$ \\
          \href{https://youtu.be/p_ZZbK051EQ}{\textbf{[VIDEO]} Դիտել լուծումը YouTub-ում (ID: p\_ZZbK051EQ)}
    
    \item Դեկարտյան արտադրյալ. $A \times (B \cup C) = (A \times B) \cup (A \times C)$ \\
          \href{https://youtu.be/FtAsJzpgkPc}{\textbf{[VIDEO]} Դիտել լուծումը YouTube-ում (ID: FtAsJzpgkPc)}
    \end{itemize}

\item \textbf{Մաթեմատիկական ինդուկցիա.}
    \begin{itemize}
    \item Ապացուցել, որ $2 + 4 + \dots + 2n = n^2 + n$ \\
          \href{https://youtu.be/oq7DfdkKNnw}{\textbf{[VIDEO]} Դիտել լուծումը YouTube-ում (ID: oq7DfdkKNnw)}

    \item Ապացուցել, որ $3^{n+2} + 4^{2n+1}$-ը բաժանվում է 13-ի \\
          \href{https://youtu.be/OKri1L7-XiI}{\textbf{[VIDEO]} Դիտել լուծումը YouTube-ում (ID: OKri1L7-XiI)}

    \item Ապացուցել, որ $10^n - 1$-ը բաժանվում է 9-ի \\
          \href{https://youtu.be/bTV2h8UZD1k}{\textbf{[VIDEO]} Դիտել լուծումը YouTube-ում (ID: bTV2h8UZD1k)}

    \item Նյուտոնի բինոմի բանաձևի ապացույցը ինդուկցիայով \\
          \href{https://youtu.be/EweFcxF17Uk}{\textbf{[VIDEO]} Դիտել լուծումը YouTube-ում (ID: EweFcxF17Uk)}

    \item Հանոյի աշտարակի խնդիրը \\
          \href{https://youtu.be/mFfO9URgqX8}{\textbf{[VIDEO]} Դիտել լուծումը YouTube-ում (ID: mFfO9URgqX8)}
    \end{itemize}
