...
Որոշելու համար` «արդյո՞ք $x \in S$»՝ թվարկեք $S$-ի տարրերը և ստուգեք, թե արդյոք $x$-ը դրանցից մեկն է։
...
\begin{tikzpicture}[
  ...
  \draw[->, thick, gray!70!black] (e0) -- (e1)
    node[midway, above, font=\footnotesize]{փաթեթավորել $\{\;\}$-ում};
...
Երկու $\in$-քայլը հատում է \emph{երկու} մակարդակ, ուստի $A$-ն թաղված է $C$-ի ներսում,
բայց $C$-ի անմիջական տարր չէ։
...
\]
Քանի որ յուրաքանչյուր դրական ամբողջ թիվ կա՛մ զույգ է, կա՛մ կենտ, և երբեք երկուսը միասին, ապա $A \cup B = \Z^+$ և $A \cap B = \varnothing$:
\[
  \boxed{A \symdiff B = \Z^+}
\]
...
Մենթալ մոդել. «$X \setminus C$» նշանակում է
«սկսիր $X$-ից, \textbf{հեռացրու} այն ամենը, ինչ $C$-ում է»։

Միավորումից $C$-ն հեռացնելը նույնն է, ինչ յուրաքանչյուր մասից առանձին $C$-ն հեռացնելը,
այնուհետև մնացորդները միավորելը։
...
Այժմ արտահայտեք յուրաքանչյուր կողմը ըստ իր տիրույթների համարների․
\begin{itemize}[nosep]
