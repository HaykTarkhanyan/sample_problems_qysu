...
$\binom{5}{2}=10$ that the all-positive convention would give - and smaller still is the count $3$ if
the three summands were treated as \emph{unordered} ($\{1,1,4\},\{1,2,3\},\{2,2,2\}$). Three
readings, three numbers ($28$, $10$, $3$); here we count ordered triples with zeros allowed.
